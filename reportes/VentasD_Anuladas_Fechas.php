...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1) {
            ...
            $this->Cell(105, 10, 'VENTAS (DETALLES) ANULADAS ENTRE EL ' . $fecha1 . ' Y ' . $fecha2, 0, 0, 'C');
...
$objVenta =  new Venta();
$listado = $objVenta->Listar_Ventas_Detalle('FECHAS', $fecha1, $fecha2, 0);
$totales = $objVenta->Listar_Ventas_Totales('FECHAS', $fecha1, $fecha2, 0);
