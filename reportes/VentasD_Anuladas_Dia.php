...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1) {
            ...
            $this->Cell(105, 10, 'VENTAS (DETALLADAS) ANULADAS DEL DIA ' . strtoupper($dias[date('w')]) . " " . strtoupper(date('d')) . " DE " . strtoupper(
                $meses[date('n') - 1]
...
$objVenta =  new Venta();
$listado = $objVenta->Listar_Ventas_Detalle('HOY', '', '', 0);
$totales = $objVenta->Listar_Ventas_Totales('HOY', '', '', 0);
