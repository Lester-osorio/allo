				...
				<div id="modal_iconified" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												...
												<input type="text" id="txtNombre" name="txtNombre" placeholder="EJ. LESTER OSORIO / ALLO"
												 class="form-control" style="text-transform:uppercase;"
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 1010-1010"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6">
												<label>Email</label>
												<input type="email" id="txtEmail" name="txtEmail" placeholder="EJ. llantas@quiche.com"
												 class="form-control">
											</div>
										</div>
									</div>
                           ...
                           placeholder="EJ. 5TA CALLE 6TA AVENIDA SANTA CRUZ DEL QUICHE"
