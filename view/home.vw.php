		...
		<div class="panel panel-body bg-indigo-400 has-bg-image">
			<div class="media no-margin">
				...
				<div class="media-body text-right">
					...
					<span class="info-box-text">INVERTIDO EN STOCK</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="panel panel-body bg-orange-400 has-bg-image">
			<div class="media no-margin">
				...
				<div class="media-body text-right">
					...
					<span class="info-box-text">PRESENTACIONES</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="panel panel-body bg-slate-400 has-bg-image">
			<div class="media no-margin">
				...
				<div class="media-body text-right">
					...
					<span class="info-box-text">PRODUCTOS INGRESADOS</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="panel panel-body bg-danger-600 has-bg-image">
			<div class="media no-margin">
				<div class="media-body">
					...
					<span class="info-box-text">PERECEDEROS</span>
				</div>
		...
		<div class="panel panel-body bg-info-300 has-bg-image">
			<div class="media no-margin">
				<div class="media-body">
					...
					<span class="info-box-text">VENCE EN 30 DIAS</span>
				</div>
			...
			<div class="media no-margin">
				<div class="media-body">
					<h3 class="no-margin">
						...
						$objDashboard = new Dashboard();
						$gananciaNetaTotal = $objDashboard->CalcularGananciaNetaTotal();
						echo "Ganancia Neta Total: $moneda $gananciaNetaTotal";
		...
		<div class="panel panel-body bg-violet-400 has-bg-image">
			<div class="media no-margin">
				<div class="media-body">
					...
					<span class="info-box-text">CREDITOS PENDIENTES</span>
				</div>
...
<script>
	...
	var line_chart = c3.generate({
		...
		data: {
			columns: [
				['COMPRAS', <?php foreach ($compras as $row => $column) {
								print($column['total'] . ',');
							} ?>],
				['VENTAS', <?php foreach ($ventas as $row => $column) {
								print($column['total'] . ',');
							} ?>]
			],
			type: 'spline'
	...
	var pie_chart = c3.generate({
		...
		data: {
			x: 'x',
			columns: [
				['x', <?php foreach ($compras as $row => $column) {
							print('"' . $column['mes'] . '",');
						} ?>],
				['MONTO', <?php foreach ($compras as $row => $column) {
								print($column['total'] . ',');
							} ?>]
			],
			type: 'bar',
	...
	var pie_chart = c3.generate({
		...
		data: {
			x: 'x',
			columns: [
				['x', <?php foreach ($ventas as $row => $column) {
							print('"' . $column['mes'] . '",');
						} ?>],
				['MONTO', <?php foreach ($ventas as $row => $column) {
								print($column['total'] . ',');
							} ?>]
			],
			type: 'bar',
