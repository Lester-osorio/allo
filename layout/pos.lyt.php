...
<head>
	...
	<meta name="autor" content="AUTO LLANTAS DE OCCIDENTE">
	<meta name="description" content="AUTO LLANTAS DE OCCIDENTE | INVENTARIO">
	<title>AUTO LLANTAS DE OCCIDENTE | INVENTARIO</title>
	...
	<link href="web/assets/css/core.minify.css" rel="stylesheet" type="text/css">
...
<body class="has-detached-right">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-header" href="./?View=Inicio"></a>
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<p class="navbar-text" style="font-weight: bold;"><span>AUTO LLANTAS DE OCCIDENTE &nbsp; &nbsp;</span><span class="label bg-success">En Linea</span>
				<span class="label bg-danger">

					<?php

					$objDashboard = new Dashboard();
					$cantidadProductosStockBajo = $objDashboard->CantidadProductosStockBajo();

					echo "Cantidad de Productos para Reorden: $cantidadProductosStockBajo";
					?>
